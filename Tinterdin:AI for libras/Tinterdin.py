...
from Brain.openai import Reply
from Brain.openaiqna import QutionsReply
    ...
    while True:
        try:
            ...
            while True:
                ...
                elif "enter hacking mode" in Data:
                    #from Hacking.Commands_run import run_command
                    Speak("This feature is currently in development, Sorry!")
